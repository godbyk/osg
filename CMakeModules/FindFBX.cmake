...
string(REPLACE "." "" FBX_VERSION_CLEAN ${FBX_VERSION})
...
ELSEIF((CMAKE_COMPILER_IS_GNUCXX OR "${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang") AND CMAKE_SIZEOF_VOID_P EQUAL 8)
    SET(FBX_LIBDIR ${FBX_LIBDIR}/x64)
ELSE()
...
IF(APPLE)
    SET(FBX_LIBNAME "fbxsdk-${FBX_VERSION}-static")
ELSEIF(CMAKE_COMPILER_IS_GNUCXX OR "${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
    SET(FBX_LIBNAME "fbxsdk-${FBX_VERSION}-static")
ELSE()
    SET(FBX_LIBNAME "fbxsdk-${FBX_VERSION}-md")
ENDIF()
...
SET( FBX_SEARCH_PATHS
    $ENV{FBX_DIR}
    $ENV{ProgramW6432}/Autodesk/FBX/FbxSdk/${FBX_VERSION}
    $ENV{PROGRAMFILES}/Autodesk/FBX/FbxSdk/${FBX_VERSION}
